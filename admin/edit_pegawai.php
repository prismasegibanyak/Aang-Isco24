...
if ($result->num_rows === 0) {
    die("Pegawai dengan NIP tersebut tidak ditemukan.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama) || empty($username) || empty($email) || empty($no_hp)) {
        ...
        $hashedPassword = !empty($password) ? password_hash($password, PASSWORD_BCRYPT) : $pegawai['password_pegawai'];

        // Update data pegawai
        $updateSql = "UPDATE pegawai SET nama_pegawai = ?, username_pegawai = ?, password_pegawai = ?, email_pegawai = ?, no_hp_pegawai = ? WHERE nip_pegawai = ?";
        ...
        if ($updateStmt->execute()) {
            ...
            $pegawai['username_pegawai'] = $username;
            $pegawai['email_pegawai'] = $email;
            $pegawai['no_hp_pegawai'] = $no_hp;
        } else {
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="profile_pegawai.php" class="active"><i class="fas fa-users"></i> Profil Pegawai</a>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="edit-pegawai-content">
            <div class="register-form">
                ...
                <form method="POST" action="">
                    <div class="input-group">
                        ...
                        <input type="text" id="nip" name="nip" value="<?php echo htmlspecialchars($pegawai['nip_pegawai']); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <label for="nama">Nama Pegawai</label>
                        <input type="text" id="nama" name="nama" value="<?php echo htmlspecialchars($pegawai['nama_pegawai']); ?>" required>
                    </div>
                    <div class="input-group">
                        <label for="username">Username</label>
                        <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($pegawai['username_pegawai']); ?>" required>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($pegawai['email_pegawai']); ?>" required>
                    </div>
                    <div class="input-group">
                        <label for="no_hp">No. HP</label>
                        <input type="text" id="no_hp" name="no_hp" value="<?php echo htmlspecialchars($pegawai['no_hp_pegawai']); ?>" required>
                    </div>
