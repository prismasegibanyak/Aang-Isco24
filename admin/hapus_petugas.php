...
// Menghapus data petugas berdasarkan NIP
$sql = "DELETE FROM petugas WHERE nip_petugas = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $nip);

if ($stmt->execute()) {
    header("Location: profile_petugas.php?message=success");
    exit();
} else {
...
<body>
    <div class="hapus-content">
        ...
        <a href="profile_petugas.php">Kembali ke Profile Petugas</a>
    </div>
    <footer class="footer">
