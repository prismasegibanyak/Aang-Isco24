            ...
            <div class="table-responsive">
                <table>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            <td data-label="NIP"><?php echo htmlspecialchars($row['nip_pegawai']); ?></td>
                            <td data-label="Nama"><?php echo htmlspecialchars($row['nama_pegawai']); ?></td>
                            <td data-label="Username"><?php echo htmlspecialchars($row['username_pegawai']); ?></td>
                            <td data-label="Email"><?php echo htmlspecialchars($row['email_pegawai']); ?></td>
                            <td data-label="No HP"><?php echo htmlspecialchars($row['no_hp_pegawai']); ?></td>
                            <td data-label="Role"><?php echo htmlspecialchars($row['role']); ?></td>
                            <td data-label="Aksi">
                                <a href="edit_pegawai.php?nip=<?php echo urlencode($row['nip_pegawai']); ?>" class="button-edit"><i class="fas fa-edit"></i> Edit</a>
                                <a href="hapus_pegawai.php?nip=<?php echo urlencode($row['nip_pegawai']); ?>" class="button-hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
