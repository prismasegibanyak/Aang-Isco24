...
<head>
    ...
    <title>Daftar Usulan Belum Dijawab | SiPAK</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI',Tahoma,Geneva,Verdana,sans-serif; }
        ...
        /* Status Styles */
        .status-selesai { color: var(--success-color); font-weight: 600; }
        .status-proses { color: var(--warning-color); font-weight: 600; }
        .status-ditolak { color: var(--danger-color); font-weight: 600; }
        .status-pihak-ke-3 { color: var(--accent-color); font-weight: 600; }
        /* File Styles */
        .list-file-img {
            max-width: 150px; max-height: 150px; display: block; margin: 0 auto;
            border-radius: 7px; box-shadow: 0 2px 8px rgba(51,107,135,0.07);
        }
        .file-link {
        ...
        @media (max-width: 768px) {
            ...
            .list-file-img { max-width: 90vw; max-height: 120px; }
        }
    </style>
</head>
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="daftar_konsultasi_belum_dijawab.php" class="active"><i class="fas fa-clock"></i> Belum Dijawab</a>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="list-content">
            <div class="welcome-section">
                <h1>Daftar Usulan Belum Dijawab</h1>
            </div>
                        ...
                        <tr>
                            ...
                            <td data-label="Dokumen Pendukung">
                                <?php if ($row['dokumen_pendukung']): ?>
                                    ...
                                    ?>
                                        <img class="list-file-img" src="<?php echo '../uploads/' . htmlspecialchars($row['dokumen_pendukung']); ?>" alt="Dokumen Pendukung">
                                    <?php else: ?>
                                        <a class="file-link" href="<?php echo '../uploads/' . htmlspecialchars($row['dokumen_pendukung']); ?>" target="_blank">Lihat File</a>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <span class="no-file">Tidak ada file</span>
                                <?php endif; ?>
                            </td>
                            <td data-label="Status" class="status-proses"><?php echo htmlspecialchars($row['status'] ?? 'Tidak diketahui'); ?></td>
                        </tr>
                    <?php endwhile; ?>
                    </tbody>
                </table>
