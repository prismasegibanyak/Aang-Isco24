                ...
                <table class="data-table">
                    <thead>
                        <tr>
                            ...
                            <th>Aksi</th>
                            <th>Level Resiko</th>
                            <th>Persetujuan Kebenaran Data</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                                ...
                                ?>
                                    <div class="file-preview">
                                        <?php if ($fileType === 'image'): ?>
                                            <img src="../uploads/<?php echo htmlspecialchars($row['dokumen_pendukung']); ?>" style="max-width: 300px; max-height: 300px;">
                                        <?php elseif ($fileType === 'pdf'): ?>
                                            <iframe src="../uploads/<?php echo htmlspecialchars($row['dokumen_pendukung']); ?>" style="width:300%; height:900px;"></iframe>
                                        <?php else: ?>
                            ...
                            <td>
                                <?php if ($row['status'] == 'proses'): ?>
                                    <a href="jawab_konsultasi.php?id=<?php echo $row['Id_usulan']; ?>" class="button response-button"><i class="fas fa-edit"></i> Jawab</a>
                                <?php else: ?>
                                    <a href="view_jawaban.php?id=<?php echo $row['Id_usulan']; ?>" class="button response-button" style="background:var(--success-color);"><i class="fas fa-comment-dots"></i>Tanggapan</a>
                                <?php endif; ?>
                            </td>
